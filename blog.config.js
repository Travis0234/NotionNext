...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/Travis0234', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科学上网,翻墙,VPN,VPS,机场,免费,技术,openwrt,clash,v2ray,xray,sing-box,google,youtube,speedtest,测速,评测,高端,稳定,nexitally,奶昔,流量光,mitce', // 网站关键词 英文逗号隔开
