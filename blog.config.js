...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Travis', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个科学上网分享者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://travisblog.qzz.io/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科学上网,翻墙,VPN,VPS,机场,免费,技术,openwrt,clash,v2ray,xray,sing-box,google,youtube,speedtest,测速,评测,高端,稳定,nexitally,奶昔,flowercloud', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个科学上网爱好者, Hi，我是一个科学上网分享员,Hi，我是一个科技数码爱好者,欢迎来到我的博客🎉',
